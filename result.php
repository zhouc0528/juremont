...
<table>
    ...
    */
    ...
    switch ($_POST['Supplier_Term']) {
        case "FOB":
            $totalcharge = ($_POST['Product_Price']*$_POST['Quantity']*(1+$_POST['Duty']/100)/$_POST['FX_Rate']) + 
                            $seafreightdecimal + $landedcost + $whschargeperorder + ($whschargeperpallet*$pallets) + 
                            $devanning + ($storagecharge*$_POST['Storage']) + ($transportcharge*(1+$fuellevy));
        break;
        case "CNF/CIF":
            $totalcharge = ($_POST['Product_Price']*$_POST['Quantity']*(1+$_POST['Duty']/100)/$_POST['FX_Rate']) + 
    ...
    case "Direct FCL":
        switch ($_POST['Supplier_Term']) {
            case "FOB":
                $totalcharge = ($_POST['Product_Price']*$_POST['Quantity']*(1+$_POST['Duty']/100)/$_POST['FX_Rate']) + $seafreightdecimal + $landedcost;
            break;
            case "CNF/CIF":
                $totalcharge = ($_POST['Product_Price']*$_POST['Quantity']*(1+$_POST['Duty']/100)/$_POST['FX_Rate']) + $landedcost;
            break;
        };
        break;
    }
